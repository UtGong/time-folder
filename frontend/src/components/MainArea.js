  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      const dataPath = visualizationType === 'Time Series'
        ? '/home/jojogong3736/mysite/backend/data/StnData_2020-2023_dailytemp.csv'
  ...
  const handleSubmit = async () => {
    ...
    switch (visualizationType) {
      ...
      case "Stack Graph":
        payload = {
          script_name: "ts_main",
          data_name: "/home/jojogong3736/mysite/backend/data/Foreign_Exchange_Rates_Filled_Corrected.csv",
          weight: weight,
          additional_params: [
            "2000-01-01",
            "2019-12-31",
